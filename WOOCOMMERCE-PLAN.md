...
6. **Hosting-Strategie festlegen**: Entweder komplette Migration der Seite auf den neuen WordPress-Server, oder Betrieb parallel unter einer Subdomain (z. B. `shop.lhtech.de`), während die Hauptseite weiter statisch auf GitHub Pages bleibt. Bei einer Subdomain-Lösung braucht es einen eigenen Domain-/DNS-Eintrag (GitHub Pages allein reicht dafür nicht).
